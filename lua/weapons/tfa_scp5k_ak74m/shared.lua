...
--------------------------------------------------- Worldmodel
SWEP.WorldModel			    = "models/weapons/private_arsenals/w_glock17.mdl"
SWEP.Bodygroups_W = {
...
SWEP.PrintName			= "AK74-M"		         -- Weapon name (Shown on HUD)
SWEP.Manufacturer		= "Glock"
...
SWEP.Primary.RangeFalloff          = 1           -- Set to 0.8, for example, to start falling off after 80% of the range.
...
SWEP.Primary.SpreadMultiplierMax   = 0.5 --How far the spread can expand when you shoot. 
--SWEP.Primary.SpreadIncrement       = 0.3 --What percentage of the modifier is added on, per shot.  Example val: 1/3.5
SWEP.Primary.SpreadRecovery        = 1.0 --How much the spread recovers, per second. Example val: 3
