...
SWEP.VMPos                  = Vector(-3.0, -3.5, 0.75)    --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
SWEP.PrintName			= "1911"		         -- Weapon name (Shown on HUD)
...
SWEP.EventTable = {
	...
	[ACT_VM_RELOAD_EMPTY] = {
		...
		{time = 83 / 60, type = "sound", value = Sound("Weapon_1911_EmptyBolt")},
	},
	[ACT_VM_FIDGET] = {
